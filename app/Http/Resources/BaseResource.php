...
class BaseResource extends JsonResource
{
    ...
    public static function dataCollection($resource)
    {
        return new AnonymousResourceCollection($resource, get_called_class());
    }


    public static function collection($resource, $page = 0, $perPage = 0, $total = 0)
    {
    ...
    public static function paginableWithData($resource)
    {
    ...
    public static function paginable($resource)
    {
        ...
        if ($paginate) {
            ...
            if (method_exists($resource, 'paginate')) {
                ...
                return self::collection($paginator, $page, $perPage, $resourceAsCollection->count());
            }
        }
    ...
    public static function return($message = 'error!', $statusCode = 400, $status = false)
    {
        return response()->json(
            [
